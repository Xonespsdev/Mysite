...
<div class="flex-container">
	<div class="columns m-t-10">
		<div class="column">
			...
			<h4 class="title">Manage User Detail</h4>
		</div>
		<div class="column">
			<a href="{{route('users.edit')}}" class="button is-primary is-pulled-right m-r-8"><i class="fa fa-user-plus m-r-10"></i>Edit User</a>
		</div>
	</div>
	<hr class="m-t-0">
	<div class="columns">
