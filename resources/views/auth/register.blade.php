    ...
    <div class="card-color card">
      <div class="card-content" id="cardid">
          ...
          <form action="{{route('register')}}" method="POST" role="form">
            ...
            <div class="field">
              <label for="name" class="label">Name</label>
                <p class="control">
                  <input class="input {{ $errors->has('name') ? ' is-danger' : '' }}" type="text" name="name" id="name" placeholder="Name" value="{{ old('email') }}" required>
                </p>
          ...
          @endif
            ...
            <button class="button is-primary is-outlined is-fullwidth m-t-25">Register</button>
          </form>
         </div>   {{-- end of card conten --}}
     </div> <!-- end of card-->
      <h5 class="has-text-centered m-t-15"><a href="{{route('login')}}">Already have an Account</a></h5>
 </div>
</div>
